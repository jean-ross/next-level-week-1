...
3. Faça um clone desse repositório rodando: <br> `git clone https://github.com/jean-ross/next-level-week-1.git`;
4. Entre na pasta rodando pelo terminal: `cd next-level-week-1`;
