...
// Iniciar o objeto que irá fazer operações no banco de dados, criando o arquivo de database
const db = new sqlite3.Database("./src/database/database.db")

// Exportar o banco de dados como módulo, para ser utilizado em outros arquivos através do require("...")
module.exports = db
